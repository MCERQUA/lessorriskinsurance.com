      ...
      <div className="container-wide">
        <FadeIn className="max-w-3xl mb-12 md:mb-16">
          ...
          <h2 className="mt-3 h-section">
            From quote request to bound policy in{" "}
            <span className="text-clay">about a day</span>.
          </h2>
          <p className="mt-4 lead">
            No back-and-forth for two weeks. A real conversation, real markets, and a
            program you can actually understand — built around your plant operation.
          </p>
        </FadeIn>
