    ...
    <footer className="relative bg-espresso text-cream overflow-hidden">
        ...
        <div>
          ...
          <ul className="space-y-3.5 text-sm">
            <li>
              <a href={SITE.phoneHref} className="flex items-start gap-2.5 text-cream/80 hover:text-gold transition-colors">
                ...
                <span>
                  ...
                  <span className="text-xs text-cream/60">Toll-free</span>
                </span>
              </a>
            </li>
            <li>
            ...
            <li className="flex items-start gap-2.5 text-cream/80">
              ...
              <span>
                {SITE.hours}<br />
                <span className="text-xs text-cream/60">24/7 claims hotline</span>
              </span>
            </li>
          </ul>
        </div>
      ...
      <div className="border-t border-white/10">
        <div className="container-wide py-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-cream/60">
          <p>
            © {year} {SITE.name}. A division of Contractors Choice Agency. All rights reserved.
          </p>
