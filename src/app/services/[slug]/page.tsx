...
export default async function ServiceDetailPage({ params }: Props) {
  ...
  const heroImg = SERVICE_IMAGE[slug] ?? "/images/hero.jpg";

  // Compose 20 FAQs (service-specific first, then general)
  const faqs = buildPageFaqs(detail?.faqs ?? [], 20);
              ...
              <FadeIn>
                <div className="rounded-3xl bg-white border border-adobe shadow-card p-7 h-full">
                  <div className="flex items-center gap-2.5 mb-5">
                    ...
                    <h2 className="font-heading font-bold text-xl text-espresso">What it covers</h2>
                  </div>
              ...
              <FadeIn delay={0.08}>
                <div className="rounded-3xl bg-espresso text-cream p-7 h-full">
                  <div className="flex items-center gap-2.5 mb-5">
                    ...
                    <h2 className="font-heading font-bold text-xl text-cream">Who it&rsquo;s for</h2>
                  </div>
                  <ul className="space-y-3">
              ...
              <FadeIn delay={0.16}>
                <div className="rounded-3xl bg-white border border-adobe shadow-card p-7 h-full">
                  <div className="flex items-center gap-2.5 mb-5">
                    ...
                    <h2 className="font-heading font-bold text-xl text-espresso">Why CCA</h2>
                  </div>
                  <ul className="space-y-3">
                    {detail.whyCca.map((c) => (
                      <li key={c} className="flex items-start gap-2.5 text-cocoa text-[0.95rem] leading-relaxed">
