  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      await fetch(WEBHOOK_URL, {
        ...
        body: JSON.stringify({ form_name: "contact", source: "framingcontractorinsurance.com", ...formData }),
      });
      setSubmitted(true);
    } catch {
              ...
              <div className="rounded-2xl bg-espresso text-cream p-6">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-cream/55 text-xs mt-0.5">24/7 claims hotline</p>
                  </div>
                </div>
              </div>
            </FadeIn>
            ...
            <FadeIn delay={0.1}>
              {submitted ? (
                <div className="p-10 rounded-3xl bg-white border border-adobe shadow-card text-center">
                  ...
                  <p className="text-mocha">Thanks for reaching out — we&rsquo;ll get back to you within one business day.</p>
                </div>
              ) : (
                <form
                  name="contact"
                ...
                >
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <input id="phone" name="phone" type="tel" value={formData.phone} onChange={handleChange} placeholder="(512) 555-0100" className={inputClass} />
                    </div>
                  </div>
