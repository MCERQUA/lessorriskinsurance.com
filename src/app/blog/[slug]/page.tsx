...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      images: [{ url: post.image || "/images/og-image.jpg", width: 1200, height: 630, alt: post.title }],
    },
    twitter: { card: "summary_large_image", title: post.title, description: post.description, images: [post.image || "/images/og-image.jpg"] },
  };
}
...
export default async function BlogPostPage({ params }: Props) {
  ...
  const blogPosting = {
    ...
    image: `${SITE.url}${post.image || "/images/og-image.jpg"}`,
